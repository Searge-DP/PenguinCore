...
public class PenguinFontRenderer extends FontRenderer {
	...
	public static void load() {
		...
		INSTANCE = new PenguinFontRenderer(mc.gameSettings, new ResourceLocation("textures/font/ascii.png"), mc.renderEngine, false);
	...
	private PenguinFontRenderer(GameSettings gameSettingsIn, ResourceLocation location, TextureManager textureManagerIn, boolean unicode) {
